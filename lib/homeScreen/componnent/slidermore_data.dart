...
import 'package:elmanhag_app/homeScreen/componnent/moreList.dart';
...
class AdsMore extends StatefulWidget {
  const AdsMore({Key? key}) : super(key: key);

  @override
  _AdsMoreState createState() => _AdsMoreState();
}

class _AdsMoreState extends State<AdsMore> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Directionality(textDirection: TextDirection.rtl, child: MoreList()),
    );
  }
}
